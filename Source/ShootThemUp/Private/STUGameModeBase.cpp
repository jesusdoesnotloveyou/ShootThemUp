...
void ASTUGameModeBase::SpawnBots()
{
    ...
    for (int32 i = 0; i < GameData.PlayersNum - 1; ++i)
    {
        ...
        const auto STUController = GetWorld()->SpawnActor<AAIController>(AIControllerClass, SpawnInfo);
...
void ASTUGameModeBase::GameTimerUpdate()
{
    ...
    RoundCountDown -= TimerRate;*/ // Alternative implementation of timer rate
...
{
    UE_LOG(LogSTUGameModeBase, Warning, TEXT("SetPause() from derived gamemode class called"));
...
bool ASTUGameModeBase::ClearPause()
{
    ...
    if (PauseCleared)
    {
        UE_LOG(LogSTUGameModeBase, Warning, TEXT("ClearPause() from derived gamemode class called"));
        SetMatchState(ESTUMatchState::InProgress);
    }
    return PauseCleared;
}
